...
class Sqlite extends PDO {
	...
	public function __construct($filename = null) {
		...
		$this->exec('CREATE TABLE IF NOT EXISTS s_keyvalue(context_id TEXT, name TEXT, value TEXT, PRIMARY KEY (context_id, name), FOREIGN KEY(context_id) REFERENCES s_contexts(id));');
